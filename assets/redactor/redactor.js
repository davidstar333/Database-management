...
(function($)
{
	...
	$.Redactor.opts = {
			...
			air: false,
			airButtons: ['formatting', 'wiii', 'italic', 'deleted', 'unorderedlist', 'orderedlist', 'outdent', 'indent'],
			...
			langs: {
				en: {
					...
					insert_row_below: 'Agregar fila abajo',
					insert_column_left: 'Agregar columna a la izquierda',
					insert_column_right: 'Agregar columna a la derecha',
					delete_column: 'Eliminar columna',
					delete_row: 'Eliminar fila',
					delete_table: 'Eliminar tabla',
					rows: 'Filas',
					columns: 'Columnas',
					add_head: 'Agregar t&iacute;tulo',
					delete_head: 'Eliminar t&iacute;tulo',
					title: 'T&iacute;ulo',
					...
					right: 'Derecha',
					center: 'Centar',
					image_web_link: 'Enlace web de imagen',
					text: 'Texto',
					mailto: 'Email',
					web: 'URL',
					video_html_code: 'Enlace de video',
					file: 'Insertar archivo',
					upload: 'Subir',
					download: 'Descargar',
					choose: 'Elegir',
					or_choose: 'O elegir',
					drop_file_here: 'Arrastra tu archivo aqu&iacute;Drop file here',
