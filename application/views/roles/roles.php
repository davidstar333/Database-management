  								        		    ...
  								        		    <div class="panel-heading">
  								        		   	...
  								        		   	<div id="<?php echo $db['db']?>__<?php echo $table?>" class="panel-collapse collapse">
  								        		      	<div class="panel-body">
  								        		        	...
  								        		        	<div class="table-responsive">
<h4>Permisos Sobre los Campos</h4>
                                          <table class="table permissionTable">
                                            <tbody>
                                                
                                                     <?php

                                           $permisos = explode(',', $theRole->permisos);





$roles = $this->tablemodel->ladb($db['db'], $table);
...
foreach ($roles as $valor) {
                               ...
                               ?>
                                                ...
                                                <tr>
                                                  <td class="permisos">
                                                    <label class="checkbox no-label" for="<?php echo $table.'.'.$valor['field']; ?>_select">
                                                     <label><input name="permisos[]" type="checkbox"  data-toggle="checkbox" <?php if(in_array($table.'.'.$valor['field'] ,$permisos)){echo "checked";}?> value="<?php echo $table.'.'.$valor['field']; ?>"  /> <?php echo $valor['field']; ?> </label>
                                                    </label>
                                                  </td>
                                                </tr>
                                              <?php } ?>
