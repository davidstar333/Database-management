...
$db = 'app_db';
    $table = 'agregar';
      ...
      public function getRole2($role)
    {
    
        $tempp = $this->db->from('dbapp_groups')->where('id', $role)->get()->result();
    ...
    */
    ...
    public function updatePermissions($permissions, $roleID, $permisos) 
    {
